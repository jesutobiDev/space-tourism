...
export default function Home() {
  return (
    <div className="h-full flex flex-col lg:flex-row justify-center lg:justify-between items-end w-full lg:pb-20 text-center lg:text-left md:px-16 lg:px-0 gap-20 flex-1">
